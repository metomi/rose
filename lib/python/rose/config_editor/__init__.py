...
TOP_MENU_METADATA_MACRO_AUTOFIX = "_Autofix"
...
TOOLBAR_TRANSFORM = "Autofix configurations (apply built-in transformer macros)"
...
DIALOG_LABEL_AUTOFIX = "Autofix configurations?"
...
DIALOG_TITLE_AUTOFIX = "Autofixer"

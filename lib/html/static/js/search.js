...
var FileLoader = ( function () {
    ...
    var loadFile = function (search_string, goto) {
        ...
        // detect search mode
        //var search_mode = $("input:radio[name=search-mode]:checked").val();
        var search_mode = document.forms['file-search']['search-mode'].value;
        // update previous search
        previous_search = search_string;
        previous_mode = search_mode;
        // the search url
        var url = '/view-search/' + user + '/' + suite;
        // search data
...
$(function () {
    ...
    // if the browser attempts to enter a form value overide it
    document.forms['file-search']['search-mode']
        .value = $('#search-mode .btn-primary').data('value');
});
...
$('#search-mode .btn').on('click', function () {
    ...
    document.forms['file-search']['search-mode'].value = $(this).data('value');
    return false;
});

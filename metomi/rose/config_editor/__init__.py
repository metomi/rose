...
[metomi.metomi.rose.config-edit]
...
Use this text to update the doc/etc/metomi.metomi.rose.rug-config-edit/metomi.metomi.rose.conf.html
text, remembering to add the [metomi.metomi.rose.config-edit] section.
...
from metomi.metomi.rose.resource import ResourceLocator
...
ERROR_METADATA_CHECKER_TEXT = (
    ...
    "Run metomi.metomi.rose.metadata-check for more info.")
...
STATUS_BAR_VERBOSITY = 0  # Compare with metomi.metomi.rose.reporter.Reporter.
...
DIALOG_TIP_SUITE_RUN_HELP = "Read the help for metomi.metomi.rose.suite-run"
...
DIALOG_TITLE_GRAPH = "metomi.metomi.rose.metadata-graph"
...
META_PROP_WIDGET = "widget[metomi.metomi.rose.config-edit]"
META_PROP_WIDGET_SUB_NS = "widget[metomi.metomi.rose.config-edit:sub-ns]"

# Miscellaneous
COPYRIGHT = (
    "Copyright (C) 2012-2020 British Crown (Met Office) & Contributors.")
HELP_FILE = "metomi.metomi.rose.rug-config-edit.html"
LAUNCH_COMMAND = "metomi.metomi.rose.config-edit"
LAUNCH_COMMAND_CONFIG = "metomi.metomi.rose.config-edit -C"
LAUNCH_COMMAND_GRAPH = "metomi.metomi.rose.metadata-graph -C"
LAUNCH_SUITE_RUN = "metomi.metomi.rose.suite-run"
LAUNCH_SUITE_RUN_HELP = "metomi.metomi.rose.help suite-run"
MAX_APPS_THRESHOLD = 10
MIN_PYGTK_VERSION = (2, 12, 0)
PROGRAM_NAME = "metomi.metomi.rose.edit"
PROJECT_URL = "http://github.com/metomi/metomi.metomi.rose."
...
load_override_config(["metomi.metomi.rose.config-edit"])
